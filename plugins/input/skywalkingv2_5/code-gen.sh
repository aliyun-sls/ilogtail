...
protoc --go_out=. --proto_path=./proto/ --go-grpc_opt=require_unimplemented_servers=false ./proto/management/*.proto --go-grpc_out=.

rm -rf ./skywalking
mv ./github.com/alibaba/ilogtail/plugins/input/skywalkingv2_5/skywalking ./
rm -rf ./github.com
