...
import (
	...
	common "github.com/alibaba/ilogtail/plugins/input/skywalkingv2_5/skywalking/network/common/v2_5"
	agent "github.com/alibaba/ilogtail/plugins/input/skywalkingv2_5/skywalking/network/language/agent/v2_5"
)
