...
type TraceSegmentReportServiceClient interface {
	...
	CollectInSync(ctx context.Context, in *SegmentCollection, opts ...grpc.CallOption) (*v2_5.Commands, error)
}
...
type TraceSegmentReportService_CollectClient interface {
	...
	CloseAndRecv() (*v2_5.Commands, error)
	grpc.ClientStream
}
...
func (x *traceSegmentReportServiceCollectClient) CloseAndRecv() (*v2_5.Commands, error) {
...
func (c *traceSegmentReportServiceClient) CollectInSync(ctx context.Context, in *SegmentCollection, opts ...grpc.CallOption) (*v2_5.Commands, error) {
...
type TraceSegmentReportServiceServer interface {
	...
	// The performance of SkyWalking OAP server would be very similar with streaming report,
	// the performance of the network and client side are affected
	CollectInSync(context.Context, *SegmentCollection) (*v2_5.Commands, error)
}
...
func (UnimplementedTraceSegmentReportServiceServer) CollectInSync(context.Context, *SegmentCollection) (*v2_5.Commands, error) {
...
type TraceSegmentReportService_CollectServer interface {
	SendAndClose(*v2_5.Commands) error
...
func (x *traceSegmentReportServiceCollectServer) SendAndClose(m *v2_5.Commands) error {
