...
type ManagementServiceClient interface {
	...
	ReportInstanceProperties(ctx context.Context, in *InstanceProperties, opts ...grpc.CallOption) (*v2_5.Commands, error)
	...
	KeepAlive(ctx context.Context, in *InstancePingPkg, opts ...grpc.CallOption) (*v2_5.Commands, error)
}
...
func (c *managementServiceClient) ReportInstanceProperties(ctx context.Context, in *InstanceProperties, opts ...grpc.CallOption) (*v2_5.Commands, error) {
	out := new(v2_5.Commands)
...
func (c *managementServiceClient) KeepAlive(ctx context.Context, in *InstancePingPkg, opts ...grpc.CallOption) (*v2_5.Commands, error) {
	out := new(v2_5.Commands)
...
type ManagementServiceServer interface {
	// Report custom properties of a service instance.
	ReportInstanceProperties(context.Context, *InstanceProperties) (*v2_5.Commands, error)
	// Keep the instance alive in the backend analysis.
	// Only recommend to do separate keepAlive report when no trace and metrics needs to be reported.
	// Otherwise, it is duplicated.
	KeepAlive(context.Context, *InstancePingPkg) (*v2_5.Commands, error)
}
...
func (UnimplementedManagementServiceServer) ReportInstanceProperties(context.Context, *InstanceProperties) (*v2_5.Commands, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ReportInstanceProperties not implemented")
}
func (UnimplementedManagementServiceServer) KeepAlive(context.Context, *InstancePingPkg) (*v2_5.Commands, error) {
